  ...
  return (
    <Section variant="white">
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-navy to-navy-light p-8 md:p-12 lg:p-16"
      >
        <FloatingShapes />
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/solutions">
              <Button
                size="lg"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-navy"
              >
                {t.cta.browseSolutions}
              </Button>
            </Link>
          </div>
        </div>
