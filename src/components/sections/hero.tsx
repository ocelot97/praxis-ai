...
/**
 * Abstract decorative illustration - flowing arcs, curves, and constellation dots.
 * Positioned to the right on desktop, behind/below on mobile.
 * Wrapped in a parallax container that moves slower than the page scroll.
 */
function HeroIllustration({ parallaxY }: { parallaxY: ReturnType<typeof useTransform<number, number>> }) {
  return (
    <motion.div
      ...
      style={{ y: parallaxY }}
    >
      {/* Right-side abstract composition - visible on all screens */}
      <svg
        viewBox="0 0 600 700"
        fill="none"
      ...
      >
        ...
        {/* Large abstract spiral/arc shape */}
        <motion.path
        ...
        {/* Constellation dots - various sizes, scattered */}
        {/* Cluster near top arc */}
        <motion.circle
          cx="480" cy="80" r="4"
          fill="#C15F3C" opacity="0.3"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
        ...
        <motion.circle
          cx="300" cy="350" r="3.5"
          fill="#C15F3C" opacity="0.18"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{ duration: 0.4, delay: 1.7 }}
        />

        {/* Lower scattered dots */}
        <motion.circle
          cx="150" cy="500" r="2"
          fill="#C15F3C" opacity="0.15"
          initial={{ scale: 0 }}
      ...
      {/* Floating accent elements with gentle animation */}
      <motion.div
...
export function Hero() {
  ...
  // Illustration moves at half speed for a parallax effect
  ...
  return (
    ...
    >
      ...
      {/* Abstract decorative illustration with parallax */}
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16">
          ...
          <div className="flex-1 flex flex-col items-start text-left max-w-2xl">
            ...
            >
              ...
              <span className="text-terracotta">Intelligent AI</span>
            </motion.h1>
            ...
            >
              We build AI-powered solutions that automate workflows, enhance
              decision-making, and scale your operations intelligently.
            </motion.p>
            ...
            >
              <div className="flex flex-col">
                ...
                <div className="mt-1 text-sm font-sans text-mid">Clients</div>
              </div>
              <div className="flex flex-col">
                <div className="text-3xl md:text-4xl font-[family-name:var(--font-caveat)] font-bold text-terracotta">
                  <CountUp target={120} suffix="+" />
                </div>
                <div className="mt-1 text-sm font-sans text-mid">
                  AI Projects
                </div>
              </div>
              <div className="flex flex-col">
          ...
          {/* Right side is filled by HeroIllustration (absolutely positioned) */}
