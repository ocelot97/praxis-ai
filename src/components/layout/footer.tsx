  ...
  return (
    <footer className="bg-navy text-white">
      <div className="section-container py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-navy-light">
          ...
          <div>
            <h3 className="text-base font-sans font-semibold mb-4">{t.footer.soluzioniHeading}</h3>
            <ul className="space-y-3">
              {t.footer.solutionLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-sm font-sans text-gray-400 hover:text-white transition-colors duration-300"
                  >
                    {link.label}
                  </Link>
                </li>
