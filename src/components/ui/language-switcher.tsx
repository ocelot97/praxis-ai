...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-2 py-1 rounded-lg text-sm font-sans font-medium text-charcoal hover:bg-charcoal/5 transition-colors duration-200"
