          ...
          <div className="prose prose-lg font-sans text-silver space-y-6">
            {locale === "it" ? (
              <>
                ...
                <h2 className="text-2xl font-semibold text-navy">Accettazione dei termini</h2>
                <p>
                  Utilizzando il sito web di Praxis AI, accetti di essere vincolato da questi termini
                  di servizio.
                </p>
                <h2 className="text-2xl font-semibold text-navy">Servizi</h2>
                <p>
                ...
                <h2 className="text-2xl font-semibold text-navy">Proprietà intellettuale</h2>
                <p>
                ...
                <h2 className="text-2xl font-semibold text-navy">Limitazione di responsabilità</h2>
                <p>
              ...
              <>
                ...
                <h2 className="text-2xl font-semibold text-navy">Acceptance of Terms</h2>
                <p>
